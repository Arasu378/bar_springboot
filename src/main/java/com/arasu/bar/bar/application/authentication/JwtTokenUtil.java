...
import static com.arasu.bar.bar.utils.Utils.ACCESS_TOKEN_VALIDITY_SECONDS;
import static com.arasu.bar.bar.utils.Utils.SIGNING_KEY;
...
public class JwtTokenUtil implements Serializable {
  ...
  private String doGenerateToken(String subject) {
      ...
      return Jwts.builder()
              .setClaims(claims)
              .setIssuer("https://kyrostechnologies.com")
  ...
  public Boolean validateToken(String token, User userDetails) {
      ...
      logger.info("UserDetails User Name : "+ userDetails.getUserEmail());
